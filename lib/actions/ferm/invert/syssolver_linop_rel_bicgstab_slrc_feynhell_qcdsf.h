...
#ifndef __syssolver_linop_rel_bicgstab_multiprec_slrc_feynhell_qcdsf_h__
#define __syssolver_linop_rel_bicgstab_multiprec_slrc_feynhell_qcdsf_h__
 ...
 *** WARNING THIS SOLVER WORKS FOR CLOVER FERMIONS ONLY ***
  ...
  class LinOpSysSolverReliableBiCGStabSlrcFeynHellQCDSF : public LinOpSystemSolver<LatticeFermion>
  {
  public:
     ...
     */
    LinOpSysSolverReliableBiCGStabSlrcFeynHellQCDSF(Handle< LinearOperator<T> > A_,
					 Handle< FermState<T,Q,Q> > state_,
					 const SysSolverReliableBiCGStabSlrcFeynHellParamsQCDSF& invParam_) : 
	...
	links_double[mu] = links[mu];
      ...
      M_single= new UnprecSlrcFeynHellDumbFLinOpQCDSF( fstate_single, tfstate_single, invParam_.clovParams, invParam_.fhParams);
      M_double= new UnprecSlrcFeynHellDumbDLinOpQCDSF( fstate_double, tfstate_double, invParam_.clovParams, invParam_.fhParams);
    ...
    ~LinOpSysSolverReliableBiCGStabSlrcFeynHellQCDSF() {}
	...
	res.resid = sqrt(norm2(r, A->subset()));
      ...
      QDPIO::cout << "RELIABLE_BICGSTAB_SLRC_FEYNHELL_SOLVER: " << res.n_count << " iterations. Rsd = " << res.resid << " Relative Rsd = " << res.resid/sqrt(norm2(chi,A->subset())) << endl;
      QDPIO::cout << "RELIABLE_BICGSTAB_SLRC_FEYNHELL_SOLVER_TIME: "<<time<< " sec" << endl;
  ...
  private:
    ...
    const SysSolverReliableBiCGStabSlrcFeynHellParamsQCDSF invParam;
