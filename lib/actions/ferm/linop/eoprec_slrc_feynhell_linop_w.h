// -*- C++ -*-
// $Id: eoprec_slrc_feynhell_linop_w.h,v 3.5 2007-11-28 22:09:15 bjoo Exp $
/*! \file
...
#ifndef __eoprec_slrc_feynhell_linop_w_h__
#define __eoprec_slrc_feynhell_linop_w_h__
...
{ 
   ...
   *      M  =  A + (d+M) - (1/2) D'
   */
  class EvenOddPrecSLRCFeynHellLinOp : public EvenOddPrecLogDetLinearOperator<LatticeFermion, 
  ...
  public:
    ...
    //! Partial constructor
    EvenOddPrecSLRCFeynHellLinOp() {}

    //! Full constructor
    EvenOddPrecSLRCFeynHellLinOp(Handle< FermState<T,P,Q> > fs,
				 const CloverFermActParams& param_,
				 const SLRCFeynHellFermActParams& fhparam_) : slrc_fs(fs)
