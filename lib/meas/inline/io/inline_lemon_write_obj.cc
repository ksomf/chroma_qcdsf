...
#include "meas/inline/io/inline_lemon_write_obj.h"
...
namespace Chroma 
{ 
  namespace InlineLemonWriteNamedObjEnv 
  { 
    namespace
    {
      ...
      const std::string name = "LEMON_WRITE_NAMED_OBJECT";
    }
    ...
    bool registerAll() 
    {
      ...
      {
        // Datatype writer
        success &= LemonWriteObjCallMapEnv::registerAll();
                           ...
                           XMLWriter& xml_out) 
    {
      ...
      push(xml_out, "lemon_write_named_obj");
      ...
      QDP_serialparallel_t parallel_io_type = QDPIO_PARALLEL;
      ...
      try {
        ...
        // Write the object
        swatch.start();
        LemonWriteObjCallMapEnv::TheLemonWriteObjFuncMap::Instance().callFunction(params.named_obj.object_type,
